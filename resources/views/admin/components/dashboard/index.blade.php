            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    <div class="info-box bg-info">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Total Social</span>
                            <span class="info-box-number">{{number_format($social)}}</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <div class="info-box bg-success">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">{{number_format($branding)}}</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <div class="info-box bg-warning">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Total Motion Graphics</span>
                            <span class="info-box-number">{{number_format($motion)}}</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <div class="info-box bg-danger">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Total Mobile</span>
                            <span class="info-box-number">{{number_format($mobile)}}</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                </div>
