                            ...
                            <div class="row">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" name="redirect" id="redirect" {{ $landingPageData->redirect ? "checked" : ""  }}>
                                        {{ form::label('redirect', 'Redirect to another link ?') }}
                                    </label>
                                </div>
                            </div>

                            <div class="row" id="url_input" @isset($landingPageData) @if ($landingPageData->redirect != 1) style="display: none" @endif
                                @else style="display: none" @endisset>
                                <div class="col-12">
                                    {{ form::text('redirect_url', $landingPageData->redirect_url, ['class' => 'form-control','placeholder' => 'Enter another link']) }}
                                </div>
                            </div>
